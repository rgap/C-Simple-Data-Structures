========================================================================
    APLICACIÓN: Información general del proyecto Proyecto_Celdas_Excel
========================================================================

AppWizard ha creado esta aplicación Proyecto_Celdas_Excel.  

Este archivo incluye un resumen acerca del contenido de los archivos que
constituyen su aplicación Proyecto_Celdas_Excel.

Proyecto_Celdas_Excel.vcproj
...
StdAfx.h, StdAfx.cpp
    ...
    precompilado (PCH) denominado Proyecto_Celdas_Excel.pch y un archivo de 
